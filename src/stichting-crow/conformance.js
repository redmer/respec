// @ts-check
// Module stichting-crow/conformance
...
export const name = "stichting-crow/conformance";
...
const localizationStrings = {
  ...
  nl: {
    ...
    normativity: `Naast onderdelen die als niet normatief gemarkeerd zijn,
      zijn ook alle diagrammen, voorbeelden, en noten in dit document niet
      normatief. Verder is alles in dit document normatief.`,
    keywordInterpretation(keywords, plural) {
      return html`<p>
        ${plural ? "De sleutelwoorden" : "Het sleutelwoord"} ${keywords} in dit
        document ${plural ? "zijn" : "is"} hebben een normatieve betekenis zoals
